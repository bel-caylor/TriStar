module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy({ "src/_data/beneficiaries.json": "beneficiaries.json" });
  eleventyConfig.addPassthroughCopy({ "src/_data/benefits.json": "benefits.json" });    
